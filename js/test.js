...
//     var fileName = 'palettes/palette' + k + '.jpg';
//     make_img(fileName, context);
// }

// // Creates an HTMLImageElement instance using a file
...
// // Polls seismometer data from sever every 250ms
// function poll() {
//     processData(a);
//     setTimeout(function() {poll()}, 250);
// }

// // Adds smoothed data points to smoothedData, updates lastRawData
...
// // Javascript object that stores arguments
// var _args = {};
// // Calls update2() every 300ms, calls main()
...
// // Called immediately when the function begins
// function main() {
...
// // Calls createBloom based on data
// function update2() {
...
//     // Scalable Vector Graphics width and height
...
// /* Utility functions taken mostly from Stack Overflow */
...
// // Resizes the main canvas width and height
