...
var a = [-58, 310, 79, 130, 150, 603, 371, 408, 425, 566, 839, 458, 790, 481, 321, 448, 295, 48, 369, 258, 381, 422, 451, 405, 300, 411, 514, 0, 544, 320, 142];
var NUM_PALETTES = 9;
...
function update2() {
    ...
    if (product > 0) {
        createBloom2(counter.toString(), time);
        counter = counter + 1;
    }
    time++;
}
...
function update(){
    ...
    for (var i = 0; i < circle_array.length; i++){
        update_circle_state2(circle_array[i]);
    }
